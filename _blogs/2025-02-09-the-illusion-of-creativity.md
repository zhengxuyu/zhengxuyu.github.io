...
1. **Historical experience** as input — the vast range of things a person has encountered, plus what evolution has encoded in the brain.
2. **Evolved neural architecture** as the processing engine — the imagination machinery: analogy, abstraction, association.
3. **Stochastic noise** as the source of variation — the randomness that ensures each recombination turns out differently.
