...
\begin{entries}{1.7in}
\gap[4pt]\textbf{Research Scientist}\par Project Leader (PL)\par Jan 2026--Present &
  \gap[4pt]Huawei Technologies R\&D UK, London\par
  \newcommand{\hwlead}{%
  - Project Leader for two feature teams, code world models (10 researchers and engineers)
  and OneManCompany (8), owning technical direction and delivery for each.\par
  - Led research and system design for \textbf{OneManCompany}, an open-source agentic AI
  platform for self-organising multi-agent systems; 400+ GitHub stars, with the design
  published as arXiv:2604.22446.\par
  \url{https://github.com/1mancompany/OneManCompany}\par}%
  \newcommand{\hwtech}{%
  - Led development of a generative code world model in which agents explore open-ended
  environments and encode the rules they discover as executable, self-improving code,
  reaching 100\% Relative
  Human Action Efficiency (RHAE) on the ARC-AGI-3 community leaderboard.\par}%
  \ifresearch \hwtech \hwlead \else \hwlead \hwtech \fi \\
\gap\textbf{Member of Technical Team}\par Aug 2025--Jan 2026 &
  \gap Inephany Ltd., London\par
  - As the company's first hire, built the multi-agent reinforcement learning training
  infrastructure for large language models and vision transformers, supporting distributed
  training runs on clusters of 500+ GPUs. \\
\gap\textbf{Algorithm Expert}\par 2024--2025\par
  \gap\textbf{Senior Algorithm}\par \textbf{Engineer}\par 2021--2024 &
  \gap Apsara Lab (now Tongyi Lab), Alibaba Cloud\par
  \newcommand{\abteam}{%
  - Led feature teams over four years, latterly 13 engineers and a 40-person data-annotation
  group, and supervised 8 research interns and junior engineers; promoted to Algorithm Expert
  in 2024.\par}%
  \newcommand{\abship}{%
  ...
  (MSMT17, Market-1501, CUHK03, DukeMTMC-reID) (IEEE TIP).\par
  \else
  ...
  \fi}%
  \ifresearch \abresearch \abship \abteam \else \abteam \abship \abresearch \fi \\
...
\begin{publist}
\pub{P2} Weihang Pan, \me, Yuxiang Zhang, Zhongming Jin, Binbin Lin, Xiaofei He, Jieping Ye.
  ``ChainPrune: Evaluating and Reducing Redundancy in Long Chain-of-Thought Reasoning''
  \venue{arXiv preprint arXiv:2608.21860}, 2026.
  \href{https://arxiv.org/abs/2608.21860}{Paper}.
